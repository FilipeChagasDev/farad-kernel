...
#define SYSTEM_TIMER_HIGH	((volatile uint_t *)(MMIO_BASE+0x000003008))
...
ullong_t get_system_timer()
{
	...
	return ((ullong_t)high_part << 32) | low_part; // Put the value of the high_part in the 
 ...
 */
void wait_usec_system_timer(uint_t number_of_micros_to_wait)
{
	ullong_t current_time;
...
ullong_t micros()
{
	ullong_t current_time = get_system_timer();
	if(current_time)
	{
		ullong_t current_time_modulo = current_time % 4;
